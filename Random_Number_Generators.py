...
def show_random_generator():
    ...
    seed_ms = st.number_input("Enter a 4-digit seed for Mid-Square Method:", min_value=1000, max_value=9999, value=1234)
    n_ms = st.number_input("How many numbers to generate?", min_value=1, max_value=100, value=10)
    ...
    a = st.number_input("Enter multiplier (a):", min_value=1, value=5)
    c = st.number_input("Enter increment (c):", min_value=0, value=3)
    m = st.number_input("Enter modulus (m):", min_value=2, value=16)
    seed_lcg = st.number_input("Enter the seed (Z0):", min_value=0, value=7)
    n_lcg = st.number_input("How many numbers to generate (LCG)?", min_value=1, max_value=100, value=10)
